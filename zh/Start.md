...
在开源社区里，有大量热心的程序员他们乐于分享自己对技术的理解、心得，他们通过各自的行动扩大自己的影响力，在协助别人的同时不断加深自己对技术的理解程度和实践能力。而新的社区加入者也可以在与社区互动的过程中找到自己技术与精神的导师(Mentor)，正如电影黑客帝国(Matrix)中尼欧(Neo)遇到摩菲(Morpheus)。
