...
* 视频教程/ScreenCast：每次讲解一个主题，学习一下总会有收获，只是效率不高。
  ...
  * MOOC课程的出现，正在改变这样的现状，不过国内的MOOC课程大多很差（简单的把视频教程搬上来就称为MOOC）
...
软件技术是近百年发展最快的技术之一，特别是随着智能手机与平板电脑的普及，软件技术更是渗透到了我们生活的各个方面。学会编程，并不意味着要去建立一个复杂的系统。其实写个报表的计算公式或者做一个小动画也可以是一种编程的体验。
...
举一个实际的例子：十多年前，PHP是一个相对冷门的编程语言。在很多场合，很多人都不好意思说自己是搞PHP开发的。而如今，PHP已经成为主流的开发工具，很多搞.net的人出于生计的考虑，不得不转向Java或者PHP。
...
**首先需要说明，这里所讨论的选择语言，并非工作中开发语言的选择，而是出于学习软件开发，以提高软件开发能力为目的，讨论如何选择语言。**
...
* 选择hacker 界公认的好语言，坚持学习，总是能收获养份的,想要获得多少,关键看能坚持多久！
...
计算机相关的基础知识，其实相当琐碎，很多人都是在日常的使用与开发过程中，逐步掌握的。在了解各种各样的零零碎碎的知识同时，对于各种知识及其相互关联，有一个整体上的把握，称之为“地图思维”，这是非常重要的。
